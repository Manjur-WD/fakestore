...
const WomenCarousel = () => {
  ...
  const getMansData = () => {
    const apiURL = "https://fakestoreapi.com/products/category/women's%20clothing?limit=4";
    fetch(apiURL)
      ...
      <section className=" womens-carousel mb-5">
        <div className="container">
          <div className="category-carousel">
            <h2 className="fw-bold">Top <span> Womens </span> Collections</h2>
            <a href="">SHOW ALL</a>
          </div>
          <div className="row mt-3">
            {womensProduct.map((items, index) => {
              return (
